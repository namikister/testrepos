# this file is made based on redmine
#
  ...
  module MenuManager
    ...
    module MenuController
      ...
      def redirect_to_project_menu_item(project, name)
        item = Testrepos::MenuManager.items(:project_menu).detect {|i| i.name.to_s == name.to_s}
...
#        end
      ...
      def menu_items_for(menu, project=nil)
        items = []
        Testrepos::MenuManager.items(menu).root.children.each do |node|
...
#          end
    ...
    class Mapper
      ...
      #   eg. :children => Proc.new {|project| [Testrepos::MenuManager::MenuItem.new(...)] }
